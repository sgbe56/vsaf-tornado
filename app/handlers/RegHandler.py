...
class RegHandler(ApplicationHandler):
    def get(self):
        return self.render('registration.html', error=0, title='Sign Up')
    ...
    def post(self):
        if self.get_argument('username') and self.get_argument('password'):
            ...
            if not login_exist:
                ...
                return self.render('registration.html', error=2, title='Sign Up')
        else:
            return self.render('registration.html', error=1, title='Sign Up')
